...
<script type="text/javascript" src="{{asset('vendor/wakatobi-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/wakatobi-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/wakatobi-menu/menu.js')}}"></script>