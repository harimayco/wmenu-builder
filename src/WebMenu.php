...
use Wakatobi\Menu\Models\Menus;
use Wakatobi\Menu\Models\MenuItems;
...
class WebMenu
{
    ...
    public function render()
    {
        ...
        if ((request()->has("action") && empty(request()->input("menu"))) || request()->input("menu") == '0') {
            return view('web-menu::menu-html')->with("menulist" , $menulist);
        } else {
            ...
            return view('web-menu::menu-html', $data);
        }
